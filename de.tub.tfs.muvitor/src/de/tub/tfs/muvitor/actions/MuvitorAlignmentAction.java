...
public class MuvitorAlignmentAction  extends SelectionAction {
	 ...
	 *            the alignment ID
	 */
	public MuvitorAlignmentAction(IEditorPart editor, int align) {
	 ...
	 *            the aligment ID.
	 */
	public MuvitorAlignmentAction(IWorkbenchPart part, int align) {
		super(part);
		alignment = align;
		initUI();
	}
