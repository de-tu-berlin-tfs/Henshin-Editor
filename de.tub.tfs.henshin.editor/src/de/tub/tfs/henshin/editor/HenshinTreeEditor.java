...
//	}
	...
	protected void createCustomActions() {
		...
		registerAction(new CreateLoopWithContentAction(this));
		registerAction(new CreateSequentialUnitWithContentAction(this));
		registerAction(new CreateConditionalUnitWithContentAction(this));
		registerAction(new CreateIndependentUnitWithContentAction(this));
		registerAction(new CreatePriorityUnitWithContentAction(this));
