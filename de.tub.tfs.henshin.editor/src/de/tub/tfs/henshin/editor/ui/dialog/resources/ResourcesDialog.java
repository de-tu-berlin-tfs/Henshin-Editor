 ...
 * @author nam
 */
public class ResourcesDialog extends TitleAreaDialog implements
		SelectionListener {
	 ...
	 *            the type
	 */
	public ResourcesDialog(Shell parentShell, ImageDescriptor titleImage,
			String title, String message, int type) {
		super(parentShell);
		this.image = titleImage == null ? IconUtil.getIcon("hse16.png")
				: titleImage.createImage();
		this.title = title;
	...
	protected Control createDialogArea(Composite parent) {
		...
		resourceGroup = new FileSelectionGroup(composite, listener,
				type == SWT.SAVE, "File name:");
	...
	public void widgetSelected(SelectionEvent e) {
		...
		Set<String> exts = ((FileSelectionGroup) resourceGroup)
				.getFileExtensions();
		String extensions = "";
		...
		if (fileLoc != null) {
			...
			Set<String> expectedExt = ((FileSelectionGroup) resourceGroup)
					.getFileExtensions();
			if (expectedExt.isEmpty()
					|| expectedExt.contains(filePath.getFileExtension())) {
