...
import de.tub.tfs.henshin.tggeditor.actions.execution.constraint.DisableConstraintAction;
import de.tub.tfs.henshin.tggeditor.actions.execution.constraint.DisableConstraintsAction;
import de.tub.tfs.henshin.tggeditor.actions.execution.constraint.EnableConstraintAction;
import de.tub.tfs.henshin.tggeditor.actions.execution.constraint.EnableConstraintsAction;
...
public class TreeContextMenuProvider extends
	...
	public void buildContextMenu(IMenuManager menu) {
		...
		dynamicAppendActionToGroup(menu, EnableConstraintsAction.ID, group);
		dynamicAppendActionToGroup(menu, EnableConstraintAction.ID, group);
		dynamicAppendActionToGroup(menu, DisableConstraintsAction.ID, group);
		dynamicAppendActionToGroup(menu, DisableConstraintAction.ID, group);
