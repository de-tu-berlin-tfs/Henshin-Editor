...
public class FormulaTree {
	 ...
	 * @param formula the formula
	 */
	private static void addApplConditions(List<NestedCondition> conditions, Formula formula) {
		if (conditions == null) {
	 ...
	 */
	private static void calculateFormulaGraph(Formula formula, List<Graph> graphs) {
