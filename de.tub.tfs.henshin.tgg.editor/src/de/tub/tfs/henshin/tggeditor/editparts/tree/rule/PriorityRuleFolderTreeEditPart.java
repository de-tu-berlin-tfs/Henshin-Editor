...
/**
 * PriorityRuleFolderTreeEditPart for priority rule folders.
 * 
 * Copied from RuleFolderTreeEditPart.
 */
public class PriorityRuleFolderTreeEditPart extends AdapterTreeEditPart<PriorityUnit> implements IDirectEditPart{
	...
	public PriorityRuleFolderTreeEditPart(PriorityUnit model) {
		super(model);
	...
	protected void notifyChanged(Notification notification) {
		...
		switch (featureId){
			...
			case HenshinPackage.PRIORITY_UNIT__SUB_UNITS: 
				...
				break;
			case HenshinPackage.PRIORITY_UNIT__DESCRIPTION:
	...
	public int getDirectEditFeatureID() {
		...
		return HenshinPackage.PRIORITY_UNIT__NAME;
	}
