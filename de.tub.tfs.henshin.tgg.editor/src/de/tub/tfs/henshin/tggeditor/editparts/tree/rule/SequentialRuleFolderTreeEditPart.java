...
/**
 * SequentialRuleFolderTreeEditPart for priority rule folders.
 * 
 * Copied from RuleFolderTreeEditPart.
 */
public class SequentialRuleFolderTreeEditPart extends AdapterTreeEditPart<SequentialUnit> implements IDirectEditPart{
	...
	public SequentialRuleFolderTreeEditPart(SequentialUnit model) {
		super(model);
	...
	protected String getText() {
		...
		return "unnamed SequentialFolder";
	}
	...
	protected void notifyChanged(Notification notification) {
		...
		switch (featureId){
			...
			case HenshinPackage.SEQUENTIAL_UNIT__SUB_UNITS: 
				...
				break;
			case HenshinPackage.SEQUENTIAL_UNIT__DESCRIPTION:
	...
	public int getDirectEditFeatureID() {
		...
		return HenshinPackage.SEQUENTIAL_UNIT__NAME;
	}
