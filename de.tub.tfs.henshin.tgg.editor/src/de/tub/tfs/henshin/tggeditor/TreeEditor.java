...
//		registerViewID(HenshinPackage.Literals.GRAPH, GRAPH_VIEW_ID);
	...
	protected void createCustomActions() {
		...
		registerAction(new EnableConstraintsAction(this));
		registerAction(new EnableConstraintAction(this));
		registerAction(new DisableConstraintsAction(this));
		registerAction(new DisableConstraintAction(this));
