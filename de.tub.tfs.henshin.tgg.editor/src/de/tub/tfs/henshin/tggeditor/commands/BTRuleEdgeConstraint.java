 ...
 */
public class BTRuleEdgeConstraint implements BinaryConstraint {
	 ...
	 */
	public BTRuleEdgeConstraint(Edge edge, 
	...
	private boolean checkEdges(DomainSlot source,DomainSlot target, Node sourceGraphNode) {
		...
		if(changeOccurred){
			...
			target.setTemporaryDomain(new HashList<EObject>(newReferredObjects));
