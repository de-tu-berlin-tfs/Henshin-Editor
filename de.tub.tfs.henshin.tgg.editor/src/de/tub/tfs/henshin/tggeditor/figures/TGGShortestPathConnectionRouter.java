...
public class TGGShortestPathConnectionRouter extends AbstractRouter {
	 ...
	 *            the container
	 */
	public TGGShortestPathConnectionRouter(IFigure container) {
		isDirty = false;
	...
	void addChild(IFigure child) {
		if (connectionToPaths == null
			|| figuresToBounds.containsKey(child)
			|| !(child instanceof NodeFigure))
			return;
