 ...
 * <ul>
 *   <li>{@link tgg.impl.NodeLayoutImpl#getX <em>X</em>}</li>
 *   <li>{@link tgg.impl.NodeLayoutImpl#getY <em>Y</em>}</li>
 *   <li>{@link tgg.impl.NodeLayoutImpl#isHide <em>Hide</em>}</li>
 *   <li>{@link tgg.impl.NodeLayoutImpl#getNode <em>Node</em>}</li>
 *   <li>{@link tgg.impl.NodeLayoutImpl#getLhsnode <em>Lhsnode</em>}</li>
 *   <li>{@link tgg.impl.NodeLayoutImpl#getAttributeLayouts <em>Attribute Layouts</em>}</li>
