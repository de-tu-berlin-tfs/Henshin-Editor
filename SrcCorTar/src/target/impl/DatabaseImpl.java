 ...
 * <ul>
 *   <li>{@link target.impl.DatabaseImpl#getTable <em>Table</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DatabaseImpl extends EObjectImpl implements Database {
	...
	protected EClass eStaticClass() {
		return TargetPackage.Literals.DATABASE;
	}
	...
	public EList<Table> getTable() {
		if (table == null) {
			table = new EObjectContainmentEList<Table>(Table.class, this, TargetPackage.DATABASE__TABLE);
		}
		return table;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case TargetPackage.DATABASE__TABLE:
