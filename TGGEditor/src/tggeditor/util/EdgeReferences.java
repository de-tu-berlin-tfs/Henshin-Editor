...
public class EdgeReferences {
	 ...
	 */
	public static List<EReference> getSourceToTargetFreeReferences(Node source, Node target) {
		List<EReference> eReferences = getSourceToTargetReferences(source, target);
