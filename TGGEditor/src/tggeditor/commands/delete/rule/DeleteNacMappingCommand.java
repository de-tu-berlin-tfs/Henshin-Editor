 ...
 *  
 * @see tggeditor.actions.DeleteNacMappingsAction
 * @see tggeditor.commands.delete.rule.DeleteRuleNodeCommand
 */
public class DeleteNacMappingCommand extends CompoundCommand {
	 ...
	 * 
	 * @see tggeditor.editparts.rule.RuleNodeEditPart#notifyChanged()
	 */
	@Override
	public void execute() {
