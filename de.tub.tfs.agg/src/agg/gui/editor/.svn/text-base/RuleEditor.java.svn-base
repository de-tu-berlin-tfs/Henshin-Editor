...
//		System.out.println("RuleEditor.setMatchMapping");
	...
	public void setRule(EdRule er) {
		if (this.eRule != null) {
			...
			this.dividerLocationSet.put(this.eRule, Integer.valueOf(this.ruleSplitPane
					.getDividerLocation()));
		}
		this.eRule = er;
		this.titleKind = " ";
...
//				Color.black));
	...
	public void resetRule() {
		if (this.eRule != null) {
			...
			if (this.dividerLocationSet.get(this.eRule) != null) {
				this.ruleSplitPane.setDividerLocation(
						(this.dividerLocationSet.get(this.eRule)).intValue());
			}
			else {
				this.ruleDividerLocation = this.ruleSplitPane.getDividerLocation();
				this.ruleSplitPane.setDividerLocation(this.ruleDividerLocation);
...
*/
	...
	public void doIdenticNAC() {
		...
		// Empty NAC Morphism is created from EdRule.createNAC(...)
	...
	public void doIdenticPAC() {
		...
		// Empty PAC Morphism is created from EdRule.createPAC(...)
