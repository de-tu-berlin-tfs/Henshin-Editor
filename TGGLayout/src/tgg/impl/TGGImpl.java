 ...
 * <ul>
 *   <li>{@link tgg.impl.TGGImpl#getSrcroot <em>Srcroot</em>}</li>
 *   <li>{@link tgg.impl.TGGImpl#getTarroot <em>Tarroot</em>}</li>
 *   <li>{@link tgg.impl.TGGImpl#getSource <em>Source</em>}</li>
 *   <li>{@link tgg.impl.TGGImpl#getCorresp <em>Corresp</em>}</li>
 *   <li>{@link tgg.impl.TGGImpl#getTarget <em>Target</em>}</li>
 *   <li>{@link tgg.impl.TGGImpl#getNodelayouts <em>Nodelayouts</em>}</li>
