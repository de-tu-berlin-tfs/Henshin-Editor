...
public class CorrespondecePackageImpl extends EPackageImpl implements CorrespondecePackage {
	 ...
	 * @generated
	 */
	private EClass genericCorrEClass = null;
	 ...
	 * @generated
	 */
	public EClass getGenericCorr() {
		return genericCorrEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getGenericCorr_Src() {
		return (EReference)genericCorrEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getGenericCorr_Tgt() {
		return (EReference)genericCorrEClass.getEStructuralFeatures().get(1);
	}
	...
	public void createPackageContents() {
		...
		genericCorrEClass = createEClass(GENERIC_CORR);
		createEReference(genericCorrEClass, GENERIC_CORR__SRC);
		createEReference(genericCorrEClass, GENERIC_CORR__TGT);
	}
	...
	public void initializePackageContents() {
		...
		initEClass(genericCorrEClass, GenericCorr.class, "GenericCorr", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getGenericCorr_Src(), ecorePackage.getEObject(), null, "src", null, 0, 1, GenericCorr.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getGenericCorr_Tgt(), ecorePackage.getEObject(), null, "tgt", null, 0, 1, GenericCorr.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
