...
public class SourceFactoryImpl extends EFactoryImpl implements SourceFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case SourcePackage.CLASS: return createClass();
			case SourcePackage.ASSOCIATION: return createAssociation();
			case SourcePackage.ATTRIBUTE: return createAttribute();
			case SourcePackage.PRIMITIVE_DATA_TYPE: return createPrimitiveDataType();
			case SourcePackage.CLASS_DIAGRAM: return createClassDiagram();
			default:
	 ...
	 * @generated
	 */
	public source.Class createClass() {
