 ...
 * @generated
 */
public class TGG_correspondenceSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public TGG_correspondenceSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case TGG_correspondencePackage.ABSTRACT_SOURCE: {
				AbstractSource abstractSource = (AbstractSource)theEObject;
				T result = caseAbstractSource(abstractSource);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TGG_correspondencePackage.ABSTRACT_TARGET: {
				AbstractTarget abstractTarget = (AbstractTarget)theEObject;
				T result = caseAbstractTarget(abstractTarget);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TGG_correspondencePackage.GEN_CORR: {
				GenCORR genCORR = (GenCORR)theEObject;
				T result = caseGenCORR(genCORR);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Gen CORR</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Gen CORR</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseGenCORR(GenCORR object) {
		return null;
	}
